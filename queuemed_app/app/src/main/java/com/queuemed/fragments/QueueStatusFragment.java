...
import com.queuemed.adapters.QueueAdapter.OnPatientClickListener;
...
public class QueueStatusFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        // Pass the OnPatientClickListener lambda to handle clicks
        adapter = new QueueAdapter(getContext(), queueList, loggedInEmail, new OnPatientClickListener() {
            @Override
            public void onPatientClick(PatientQueueItem patient) {
                // Open the patient details fragment
